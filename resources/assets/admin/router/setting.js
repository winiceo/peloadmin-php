...
import AddCoin from '../component/setting/AddCoin';
import UpdateCoin from '../component/setting/UpdateCoin';
import Site from '../component/setting/Site';
import Coins from '../component/setting/Coins';
...
const settingRouter = {
    ...
    children: [
        ...
        {path: 'coin', component: Coins},
        {path: 'addcoin', component: AddCoin},
        {path: 'updatecoin/:coin_id', component: UpdateCoin},
    ]
};
