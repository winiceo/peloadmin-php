<template>
    <div class="panel panel-default">
        <div class="panel-heading">资产流水</div>
        ...
        <div class="panel-body">
			...
			<currency-list :items="items" :loading="loading"></currency-list>
...
<script>
    ...
    import components from '../../modules/asset';
	...
	export default {
		...
		methods: {
			getList(query = {}) {
				this.loading = true;
                request.get(createRequestURI('asset'),{
		    ...
		    buildRoute(offset) {
		      ...
		      return { path: '/asset', query: { ...query, offset } };
		    },
		},
		created() {
