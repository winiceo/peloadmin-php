...
use Leven\Models\Bill as BillModel;
...
class BillController extends Controller
{
     ...
     * @param  BillModel $report
     * @return mixed
     */
    public function deal(Request $request, BillModel $report)
    {
     ...
     */
    public function reject(Request $request, BillModel $report)
    {
        $mark = $request->input('mark');
        $report->status = 2;
        $report->mark = $mark;
