...
use Leven\Http\Requests\API2\StoreUserBalanceWithdrawPost;
...
class BalanceWithdrawController extends Controller
{
     ...
     * @author Seven Du <shiweidu@outlook.com>
     */
    public function store(StoreUserBalanceWithdrawPost $request)
    {
